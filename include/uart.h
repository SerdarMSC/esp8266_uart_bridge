...
//=======================================
typedef void (*uart_rx_callback)(int length);

void uart_init_new(int baud, uart_rx_callback callback);
STATUS uart_tx_one_char(uint8 uart, uint8 TxChar);

#define uart_rx_one_char(uart_no) (unsigned char)(READ_PERI_REG(UART_FIFO(uart_no)) & 0xFF)
